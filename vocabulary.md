...
1. **Übertragen** – to transfer / transmit
...
1. **WLAN-Anschluss** – Wi-Fi connection
...
1. **abgesehen davon** – Apart from that or aside from that
...
1. **Mandant** - client
1. **Währungsrechner** - currency converter
...
1. **Abstürzte** - crashed
1. **Berufseinsteiger** - entry-level professional
1. **Ursache** - cause
1. **Lösung** - solution
...
1. **überflüssig** – unnecessary
   ...
   - Das war ein überflüssiger Kommentar.
...
1. **ewig** – eternal / forever

   - Ich werde dich ewig lieben.

1. **Spickzettel** – cheat sheet (for exams)

1. **scheitern an** – to fail due to

   - Das Projekt ist am Geldmangel gescheitert.

1. **etwas näher erläutern** – to explain something in more detail
   - Können Sie das näher erläutern?
1. **bestrafen** – to punish
1. **sich austauschen mit/über** – to exchange ideas with/about
1. **wirken auf** – to have an effect on
1. **erwarten von** – to expect from
1. **Du hast alles richtig gemacht, demnach wirst du belohnt.**  
   You did everything right, thus you will be rewarded.
1. **ausfallen** – to fail / to be canceled  
   Das Konzert ist ausgefallen.
1. **nachhaken** – to follow up / to ask further  
   Der Journalist hakte nach, um mehr Informationen zu bekommen.
1. **übrig gebliebene** – leftover / remaining  
   Ich esse die übrig gebliebenen Reste.
1. **anlehnen** – to lean (against something)
1. **aufheben** – to lift up / to keep safely / to cancel
   - Ich habe das Dokument aufgehoben.
1. **jemanden schätzen** – to value or appreciate someone
   - Ich schätze meine Freunde sehr.
1. **etwas schätzen** – to estimate something
   - Ich schätze den Preis auf 100 Euro.
1. **eifersüchtig sein auf** – to be jealous of
1. **neidisch sein auf** – to be envious of
1. **angesehen sein bei** – to be respected by
1. **bereit zu** – ready to
1. **einverstanden sein mit** – to agree with
1. **erstaunt sein über** – to be amazed/surprised by
1. **entschieden sein für** – to be firmly in favor of
1. **schädlich sein für** – to be harmful to
1. **verrückt sein nach** – to be crazy about
1. **beliebt sein bei** – to be popular with
1. **entsetzt sein über** – to be horrified/shocked by
1. **schuld sein an** – to be responsible for (something negative)
1. **sich etwas einprägen** – to memorize
1. **etwas kommt mir bekannt vor** – something seems familiar
1. **grob schätzen** – to roughly estimate
   - Ich habe die Kosten grob geschätzt.
1. **ausgehend von** – based on
   - Ausgehend von deinen Angaben haben wir den Plan erstellt.
1. **im Grunde genommen** – basically / essentially
   - Im Grunde genommen hast du recht.
1. **Einschätzung** – assessment / evaluation
1. **pleitegehen** – to go bankrupt
   - Viele Firmen sind während der Krise pleitegegangen.
1. **anscheinend** – apparently / seemingly
1. **daraufhin** – as a result / therefore (in the past)
1. **Auffassung** – opinion / perception / understanding
   - Meiner Auffassung nach ist das falsch.
1. **abschneiden** – to cut off / to perform (well or badly)
1. **rächen** – to take revenge / to avenge
1. **Einwohnerzahl** – population
1. **aufbewahren** – to keep / to store / to preserve
1. **retten** – to rescue / to save
1. **sich sträuben** – to resist / to refuse stubbornly
1. **ertragen** – to endure / to bear / to tolerate
1. **im Zweifelsfall** – in case of doubt
   - Im Zweifelsfall frage ich den Lehrer.
